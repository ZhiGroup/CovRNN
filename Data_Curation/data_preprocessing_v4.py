...
if __name__ == '__main__':
    ...
    data_dat.columns = ["Pt_id", "ICD", "Time"]     #data_dat=data_dat[~(data_dat["ICD"].str.startswith('SNOMED') |data_dat["ICD"].str.startswith('L'))] ### use if you need to exclude or include only certain type of codes
